...
export class CatPlugin extends Plugin {
    ...
    public async execute(message: IMessage, args?: string[]) {
        ...
        if (args[0].includes('bread')) {

            //Simply return the bread easter egg.

            message.reply('', {
                file: 'https://www.thetoychronicle.com/wp-content/uploads/2016/06/The-BREADCAT-By-Rato-Workroom-boxcat.jpg',
            });
            return;
        }
